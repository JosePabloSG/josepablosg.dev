...
export const lgLayout: Layout[] = [
    ...
    { i: 'project-1', x: 3, y: 3, w: 1, h: 2 },
    { i: 'project-2', x: 1, y: 3, w: 2, h: 1 },
    { i: 'spotify', x: 0, y: 4, w: 1, h: 1 },
...
export const mdLayout: Layout[] = [
    ...
    { i: 'location', x: 3, y: 0, w: 2, h: 1 },
    { i: 'project-1', x: 4, y: 2, w: 1, h: 2 },
    { i: 'project-2', x: 0, y: 5, w: 2, h: 2 },
