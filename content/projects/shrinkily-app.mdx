...
technologies: [{"name": "React", "icon": "/icons/React.svg"}, {"name": "Next.js", "icon": "/icons/Nextjs.svg"}, {"name": "TypeScript", "icon": "/icons/Typescript.svg"}, {"name": "Tailwind CSS", "icon": "/icons/Tailwindcss.svg"},{"name": "shadcn/ui", "icon": "/icons/shadcn-ui.svg"}, {"name": "Frame Motion", "icon": "/icons/Framermotion.svg"}, {"name": "Json Web Tokens", "icon": "/icons/Jwt.svg"}, {"name": "Auth0", "icon": "/icons/Auth0.svg"}, {"name": "Prisma", "icon": "/icons/Prisma.svg"}, {"name": "EsLint", "icon": "/icons/Eslint.svg"}, {"name": "Zod", "icon": "/icons/Zod.svg"},{"name": "Next intl", "icon": "/icons/Global.svg"}]
---
