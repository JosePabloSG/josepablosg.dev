...
technologies: [{"name": "React", "icon": "/icons/React.svg"}, {"name": "Next.js", "icon": "/icons/Nextjs.svg"}, {"name": "TypeScript", "icon": "/icons/Typescript.svg"}, {"name": "Tailwind CSS", "icon": "/icons/Tailwindcss.svg"},{"name": "shadcn/ui", "icon": "/icons/shadcn-ui.svg"},{"name": "Tanstack Query", "icon": "/icons/tanstack.svg"}, {"name": "Zustand", "icon": "/icons/zustand.svg"}, {"name": "Json Web Tokens", "icon": "/icons/Jwt.svg"}, {"name": "EsLint", "icon": "/icons/Eslint.svg"}, {"name": "Zod", "icon": "/icons/Zod.svg"}]
---
